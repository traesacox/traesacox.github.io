const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&APPID=216ae8f50dc7f7842c02d428622bbfc4";
fetch(apiURL)
...
//----------Five Day Forecast--------------
const forecastAPIURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&APPID=216ae8f50dc7f7842c02d428622bbfc4";
    ...
    .then(function (jsonObject) {
        ...
        for (let i = 0; i < towns.length; i++) {
            if ((towns[i].name == "Fish Haven")) {
                ...
                eventPic.setAttribute("src", "images/TownChristmasTree-Events.jpg");
                eventPic.setAttribute("alt", "Photo of lighted Christmas Tree");
